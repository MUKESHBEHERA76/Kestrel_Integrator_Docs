...
export const DOCS_SECTIONS = {
  ...
  connectors: {
    title: 'Connections',
    intro: 'Connections are reusable credentials and endpoint definitions. The connection page shows the actual connector icon and the enabled state used by runtime features.',
    cards: [
      { title: 'Catalog first', body: 'Open the catalog, choose the connector type, then configure host, port, database, username, password, or other required fields.' },
      ...
      { title: 'Reuse everywhere', body: 'Once saved, the connection can be picked in workflows, services, and the SQL console.' }
    ]
  },
  workflow: {
    title: 'Workflow',
    intro: 'Workflow pipelines connect trigger, action, branch, and utility steps. The designer keeps the canvas and mapping flow fixed while you build.',
    cards: [
